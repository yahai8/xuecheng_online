...
public enum MediaCode implements ResultCode {
    ...
    UPLOAD_FILE_REGISTER_CREATEFOLDER_FAIL(false, 22006, "文件注册创建文件失败"),
    UPLOAD_FILE_IS_NULL(false, 22007, "上传文件为空"),
    CHUNK_FILE_UPLOAD_FAIL(false, 22008, "块文件创建失败"),
    MEGER_FILE_CREATEFAIL(false, 22009, "合并文件创建失败"),
    CHECK_FILE_MD5_FAIL(false, 22010, "校验md5失败");
