...
public class RabbitMQConfig {
    ...
    public Queue QUEUE_DECLARE_finishaddchoosecourse() {
    ...
    public Queue QUEUE_DECLARE_ADDCHOOSECOURSE() {
     ...
     */
    @Bean
    public Binding binding_queue_order_finishaddchoosecourse(@Qualifier("xc_learning_finishaddchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with(XC_LEARNING_FINISHADDCHOOSECOURSE_KEY).noargs();
    }

    @Bean
    Binding binding_queue_order_addchoosecourse(@Qualifier("xc_learning_addchoosecourse") Queue queue,@Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
